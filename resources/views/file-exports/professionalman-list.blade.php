<div class="row">
    <div class="col-lg-12 text-center "><h1 >{{ translate('Professionalman_List') }}</h1></div>
    <div class="col-lg-12">
    ...
    <table>
        <thead>
            ...
            <tr>
                ...
                <th></th>
                <th>
                    {{ translate('total_professional_man')  }}- {{ $data['professional_men']->count() }}
                    <br>
                    {{ translate('active_professional_man')  }}- {{ $data['professional_men']->where('status',1)->count()}}
                    <br>
                    {{ translate('inactive_professional_man')  }}- {{ $data['professional_men']->where('status',0)->count() }}
                </th>
                <th> </th>
                <th></th>
                <th></th>
        ...
        <tr>
            ...
            <th>{{ translate('Professionalman_Type') }}</th>
