<div class="row">
    <div class="col-lg-12 text-center "><h1 > {{ translate('Service_Campaign_List') }}
    </h1></div>
    <div class="col-lg-12">
    ...
    <table>
        ...
        <td>
            {{ \App\CentralLogics\Helpers::get_service_variations($campaign->variations) == "  "  ? translate('N/A'): \App\CentralLogics\Helpers::get_service_variations($campaign->variations) }}
        </td>
        <td>
