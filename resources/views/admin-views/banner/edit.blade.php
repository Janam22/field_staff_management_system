                                ...
                                <div class="js-nav-scroller hs-nav-scroller-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="banner_type" name="banner_type" class="form-control banner_type_change">
                                            <option value="general_wise" {{$banner->type == 'general_wise'? 'selected':'' }}>{{translate('messages.general_wise')}}</option>
                                            <option value="item_wise" {{$banner->type == 'item_wise'? 'selected':'' }}>{{translate('messages.service_wise')}}</option>
                                        </select>
                                    </div>
                                    <div class="form-group" id="item_wise">
                                        <label class="input-label" for="exampleFormControlInput1">{{translate('messages.select_service')}}</label>
                                        <select name="item_id" id="choice_item" class="form-control js-select2-custom" placeholder="{{translate('messages.select_service')}}">
           ...
           if(order_type=='item_wise')
            {
                $('#general_wise').hide();
                $('#item_wise').show();
                getRequest('{{url('/')}}/admin/service/get-services?zone_id={{$banner->zone_id}}&data[]={{$banner->data}}','choice_item');
            }
            else if(order_type=='general_wise')
            {
                $('#general_wise').show();
                $('#item_wise').hide();
            }
