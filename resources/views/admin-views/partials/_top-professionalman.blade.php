...
<div class="card-header">
    <h5 class="card-header-title">
        ...
        <span>{{ translate('Top_Professionalman') }}</span>
    </h5>
...
<div class="card-body">
    <div class="row g-2">
        @foreach($top_professionalman as $key=>$item)
            <div class="col-md-4 col-6 redirect-url" data-url="{{route('admin.professional-man.preview',[$item['id']])}}">
