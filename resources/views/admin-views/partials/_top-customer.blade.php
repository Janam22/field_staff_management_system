...
<div class="card-body">
    <div class="row">
        @foreach($top_customer as $key=>$item)
            <div class="col-6 col-md-4 mt-2 initial-40 redirect-url" data-url="{{route('admin.customer.view',[$item['id']])}}">
                <div class="grid-card min-height-100">
                    ...
                    <div class="text-center mt-2">
                        <span class="fz-10px">{{$item['f_name']?? translate('messages.Not_exist')}}</span>
                    </div>
                </div>
            </div>
        @endforeach
