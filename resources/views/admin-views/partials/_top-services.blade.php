...
<div class="card-header">
    <h5 class="card-header-title">
        ...
        <span>{{translate('messages.most_used_services')}}</span>
    </h5>
...
<div class="card-body">
    <div class="row g-2">
        @foreach($top_services as $key=>$item)
            <div class="col-md-4 col-sm-6">
                <div class="grid-card top-selling-food-card pb-3 redirect-url" data-url="{{route('admin.service.view',[$item['id']])}}">
