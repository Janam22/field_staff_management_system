...
class DatabaseSettingController extends Controller
{
    public function db_index()
    {
        ...
        $filter_tables = array(
            'admin_roles', 'admins', 'business_settings', 'colors',
            ...
            'social_medias', 'soft_credentials', 'users','email_verifications','mail_configs',
            'translations','jobs','data_settings','storages','notification_settings',
        );
